...
package com.testingjava.test34;

import java.util.concurrent.ForkJoinPool;
import java.util.concurrent.RecursiveAction;

// Класс ForkJoinTask преобразует (через класс RecursiveAction) значения элементов
...
class SqrtTransform extends RecursiveAction {
    ...
    protected void compute() {
        ...
        if ((end - start) < seqThreshold) {
            ...
            // на меньшие части найти середину
...
public class TestingForkJoinPool {
...
//        ForkJoinPool fjp = ForkJoinPool.commonPool();
        ...
        fjp.invoke(task);
//        task.invoke();
        System.out.println("Чacть преобразованной последовательности (с точностью до четырех знаков после десятичной точки):");
